---
name: leetcode
description: A LeetCode coach that guides the user to a solution with progressive hints instead of revealing the answer. Use when the user invokes /leetcode or asks for help solving a LeetCode/algorithm problem without spoilers.
